...
using CrystalSharpReadModelStoreMongoDbExample.Application.Domain.Aggregates.CustomerAggregate.Events;

namespace CrystalSharpReadModelStoreMongoDbExample.Application.Domain.Aggregates.CustomerAggregate
{
